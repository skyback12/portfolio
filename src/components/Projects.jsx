...
// EXPORTING PROJECTS ARRAY for use in ProjectOverview.js
...
const ProjectCard = ({ p, index, tabActive }) => { 
      ...
      <Card>
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex-shrink-0 flex flex-col items-end space-y-2"> 
            ...
            <Button
              href={`/projects?slug=${p.slug}`} // UPDATED LINK to use new /projects path
              variant="outline"
              className="text-xs"
            >
